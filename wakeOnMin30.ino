...
// Globals
// ++++++++++++++++++++ Change me ++++++++++++++++++
uint8_t  WakeUp_StartHour       = 0;   // Hour in 24 hour clock
uint8_t  WakeUp_StartMinute     = 27;  // Minutes 
uint8_t  Bedtime_SleepHour      = 0;  // Hour in 24 hour clock
uint8_t  Bedtime_SleepMinute    = 31;  // Minutes 
...
void loop() 
{
  //Responsible for turning on the RPi for the first 5 mins to enable operation [2020]
    ...
    if(pi_awake == false)
    {
        ...
        if(mnCurr < WakeUp_StartMinute)
        {
          WakeUp_StartHour = hrCurr;
